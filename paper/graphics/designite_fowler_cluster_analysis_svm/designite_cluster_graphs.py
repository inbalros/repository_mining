...
datasets = {'designite_fowler_abstraction': 'Abstraction', 'designite_fowler_encapsulation': 'Encapsulation',
            'designite_fowler_hierarchy': 'Hierarchy', 'designite_fowler_modularization': 'Modularization'}
        ...
        dfs = {
            datasets[key]: pd.read_csv(
                Config.get_work_dir_path(
                    os.path.join("paper", "svm_cluster_analysis", key, project, "scores.csv")))
...
(ggplot(stats_df, aes(x='Score', y="Mean", fill="Smells"))
 ...
 ).save("designite_cluster_barplot.pdf")
...
(ggplot(stats_df, aes(x='Score', y="Mean", fill="Smells"))
 ...
 ).save("designite_cluster_barplot_with_values.pdf")
...
(ggplot(scores_df,
 ...
 ).save("designite_cluster_violin_plot.pdf", width=50, height=20.12, units="cm")
