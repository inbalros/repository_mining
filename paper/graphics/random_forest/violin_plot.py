...
for project in projects:
    fowler_scores_path = Config.get_work_dir_path(os.path.join("paper", "random_forest_analysis", "fowler", project, "scores.csv"))
    ...
    designite_fowler_scores_path = Config.get_work_dir_path(
        os.path.join("paper", "random_forest_analysis", "designite_fowler", project, "scores.csv"))
...
scores_order = ["F1-Score", "AUC ROC", "Brier Score"]
...
(ggplot(df,
 ...
 ).save("violin_plot.pdf", width=50, height=20.12, units="cm")
